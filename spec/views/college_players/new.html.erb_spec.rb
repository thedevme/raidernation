...
describe "college_players/new" do
  before(:each) do
    assign(:college_player, stub_model(CollegePlayer,
      :full_name => "MyString",
      :position => "MyString",
      :college => "MyString",
      :height => "MyString",
  ...
  it "renders new college_player form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => college_players_path, :method => "post" do
